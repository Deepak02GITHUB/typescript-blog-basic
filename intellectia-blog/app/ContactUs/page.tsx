    ...
    <>
      ...
      {loading && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
          <Oval height={60} width={60} color="#ffffff" secondaryColor="#e0e0e0" strokeWidth={4} />
        </div>
      )}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm">
          <div className="relative w-11/12 max-w-lg bg-white rounded-sm shadow-lg font-dm-sans animate-modalFadeIn">
            ...
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute top-3 right-3 rounded-full py-1 hover:bg-gray-100"
              aria-label="Close"
            >
              <X className="w-5 h-5" />
            </button>
      ...
      <div className="relative mb-108">
        <div className="bg-gray-800 text-black py-28 px-7 md:px-5">
          <div className="md:px-20">
            ...
            <p className="text-base md:text-xl text-white">Looking for a legal Partner? You Found.</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative flex flex-col md:flex-col lg:flex-row bg-white rounded-sm p-6 md:p-12 gap-8">
        ...
        <div className="lg:w-2/5 bg-white ml-1 p-6 rounded-md border border-gray-200">
          ...
          <div className="flex items-center gap-3 mb-3">
            <a
              href="https://www.google.com/maps/place/Intelectia+Legal+Firm/@12.961518,77.5951297,17z/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 text-gray-700 no-underline"
            >
          ...
          <div className="flex items-center gap-3">
            <a href="mailto:info@intelectia.net" className="flex items-center gap-3 text-gray-700 no-underline">
              <Mail className="w-6 h-6" />
              <p className="text-base md:text-lg">info@intelectia.net</p>
            </a>
          </div>
        ...
        <div className="ml-3 md:ml-10 mt-0 md:-mt-56 md:w-2.5/5 bg-gray-50 p-6 md:p-14 rounded-sm shadow-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-7 mt-3 -ml-2">
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={handleChange}
                  className="w-full border border-gray-400 rounded-sm p-3 focus:outline-none focus:ring-2 focus:ring-[#b43a2f] -ml-2"
                />
            ...
            <div className="-mx-3">
              <button
                type="submit"
                className="w-full bg-[#b43a2f] text-white cursor-pointer py-3 ml-1 rounded-sm hover:bg-[#a13328] transition"
              >
                SUBMIT
              </button>
            </div>
